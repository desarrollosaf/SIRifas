...
export declare class NavigationModeDirective implements OnChanges {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NavigationModeDirective, "[awNavigationMode]", never, { "awNavigationMode": { "alias": "awNavigationMode"; "required": false; }; "navigateBackward": { "alias": "navigateBackward"; "required": false; }; "navigateForward": { "alias": "navigateForward"; "required": false; }; }, {}, never, never, false, never>;
}
