...
export declare abstract class WizardStep {
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<WizardStep, never>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<WizardStep, never, never, { "stepId": { "alias": "stepId"; "required": false; }; "stepTitle": { "alias": "stepTitle"; "required": false; }; "navigationSymbol": { "alias": "navigationSymbol"; "required": false; }; "canEnter": { "alias": "canEnter"; "required": false; }; "canExit": { "alias": "canExit"; "required": false; }; }, { "stepEnter": "stepEnter"; "stepExit": "stepExit"; }, ["stepTitleTemplate", "stepSymbolTemplate"], never, false, never>;
}
