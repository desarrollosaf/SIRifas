 ...
 * @author Marc Arndt
 */
export declare class WizardComponent implements WizardBase, AfterContentInit {
    /**
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<WizardComponent, "aw-wizard", never, { "navBarLocation": { "alias": "navBarLocation"; "required": false; }; "navBarLayout": { "alias": "navBarLayout"; "required": false; }; "navBarDirection": { "alias": "navBarDirection"; "required": false; }; "defaultStepIndex": { "alias": "defaultStepIndex"; "required": false; }; "disableNavigationBar": { "alias": "disableNavigationBar"; "required": false; }; }, {}, ["wizardStepsQueryList"], ["*"], false, never>;
}
