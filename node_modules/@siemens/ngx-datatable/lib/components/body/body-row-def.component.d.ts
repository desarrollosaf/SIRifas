...
export declare class DatatableRowDefComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DatatableRowDefComponent, "datatable-row-def", never, {}, {}, never, never, false, never>;
}
export declare class DatatableRowDefDirective {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<DatatableRowDefDirective, "[rowDef]", never, {}, {}, never, never, false, never>;
}
/**
...
export declare class DatatableRowDefInternalDirective implements OnInit {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<DatatableRowDefInternalDirective, "[rowDefInternal]", never, { "rowDefInternal": { "alias": "rowDefInternal"; "required": false; }; }, {}, never, never, false, never>;
}
type RowDefContext = {
