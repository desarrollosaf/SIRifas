...
import { NgbCalendar, NgbDatepickerModule, NgbDropdownModule } from '@ng-bootstrap/ng-bootstrap';
...
let DashboardComponent = class DashboardComponent {
     ...
     * NgbDatepicker
     */
    currentDate = inject(NgbCalendar).getToday();
    /**
     * Apex chart
     */
     ...
     */
    getCustomersChartOptions(themeVariables) {
        return {
            series: [{
                    name: '',
     ...
     */
    getOrdersChartOptions(themeVariables) {
        return {
            series: [{
                    name: '',
     ...
     */
    getGrowthChartOptions(themeVariables) {
        return {
            series: [{
                    name: '',
     ...
     */
    getRevenueChartOptions(themeVariables) {
        return {
            series: [{
                    name: "Revenue",
                    data: [
     ...
     */
    getMonthlySalesChartOptions(themeVariables) {
        return {
            series: [{
                    name: 'Sales',
     ...
     */
    getCloudStorageChartOptions(themeVariables) {
        return {
            series: [67],
            chart: {
                height: 260,
