...
const defaultNav = {
    htmlCode: `<ul ngbNav #defaultNav="ngbNav" [(activeId)]="defaultNavActiveId" class="nav-tabs">
  <li [ngbNavItem]="1">
    <a ngbNavLink>One</a>
...
const horizontalCenter = {
    htmlCode: `<ul ngbNav #horizontalCenterNav="ngbNav" class="nav-tabs justify-content-center">
  <li [ngbNavItem]="1">
    <a ngbNavLink>Home</a>
    <ng-template ngbNavContent>
...
const horizontalEnd = {
    htmlCode: `<ul ngbNav #horizontalEndNav="ngbNav" class="nav-tabs justify-content-end">
  <li [ngbNavItem]="1">
    <a ngbNavLink>Home</a>
    <ng-template ngbNavContent>
      <h6 class="mb-2">Home</h6>
...
const fillJustifyNav = {
    htmlCode: `<ul ngbNav #fillJustifyNav="ngbNav" class="nav-tabs nav-fill">
  <li [ngbNavItem]="1">
    <a ngbNavLink>Home</a>
    <ng-template ngbNavContent>
      <h6 class="mb-2">Home</h6>
...
const navWidthDropdown = {
    htmlCode: `<ul ngbNav #navWithDropdown="ngbNav" class="nav-tabs">
  <li [ngbNavItem]="1">
    <a ngbNavLink>Home</a>
    <ng-template ngbNavContent>
      <h6 class="mb-2">Home</h6>
...
let NavsComponent = class NavsComponent {
    defaultNavActiveId = 1;
    defaultNavCode;
    horizontalAlignmentCenterCode;
    horizontalCenterCode;
    horizontalEndCode;
    verticalNavCode;
    fillJustifyNavCode;
    navWidthDropdownCode;
    constructor() { }
    ngOnInit() {
