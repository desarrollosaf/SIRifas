...
import { Component, Directive, EventEmitter, Input, Output, ViewChildren } from '@angular/core';
...
const sortableTable = {
    ...
    tsCode: `import { Component, Directive, EventEmitter, Input, Output, QueryList, ViewChildren } from '@angular/core';
import { DecimalPipe } from '@angular/common';
...
<table class="table table-striped">
    ...
    tsCode: `import { Component, PipeTransform } from '@angular/core';
import { AsyncPipe, DecimalPipe } from '@angular/common';
...
let TableComponent = class TableComponent {
    ...
    refreshCountries() {
        this.countries_pagination = COUNTRIES_PAGINATION.map((country, i) => ({ _id: i + 1, ...country })).slice((this.page - 1) * this.pageSize, (this.page - 1) * this.pageSize + this.pageSize);
    }
    scrollTo(element) {
