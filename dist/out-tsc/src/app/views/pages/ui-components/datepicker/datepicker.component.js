...
const defaultDatepicker = {
    htmlCode: `<ngb-datepicker #dp [(ngModel)]="selectedDate" (navigate)="date = $event.next"></ngb-datepicker>
<hr>
...
const rangeSelection = {
    htmlCode: `<ngb-datepicker class="range-selection" #dp (dateSelect)="onDateSelection($event)" [displayMonths]="2" [dayTemplate]="t" outsideDays="hidden">
</ngb-datepicker>
...
const rangeSelectionPopup = {
    htmlCode: `<form class="d-flex range-selection">
