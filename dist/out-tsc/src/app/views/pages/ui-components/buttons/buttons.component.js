...
const defaultButtons = {
    htmlCode: `<button type="button" class="btn btn-primary">Primary</button>
...
const buttonTags = {
    htmlCode: `<a class="btn btn-primary" href="" (click)="false" role="button">Link</a>
...
const outlineButtons = {
    htmlCode: `<button type="button" class="btn btn-outline-primary">Primary</button>`,
    tsCode: `import { Component } from '@angular/core';
...
const buttonSizes = {
    htmlCode: `<button type="button" class="btn btn-primary btn-lg">Large button</button>
...
const blockButton = {
    htmlCode: `<div class="d-grid gap-2">
...
const activeStateButton = {
    htmlCode: `<a href="" (click)="false" class="btn btn-primary active" role="button" aria-pressed="true">Primary link</a>
...
const disabledStateButton = {
    htmlCode: `<button type="button" class="btn btn-primary" disabled>Primary button</button>
...
const disabledStateLinkButton = {
    htmlCode: `<a href="" (click)="false" class="btn btn-primary disabled" tabindex="-1" role="button" aria-disabled="true">Primary link</a>
...
const iconButton = {
    htmlCode: `<button type="button" class="btn btn-primary btn-icon">
...
const iconTextButton = {
    htmlCode: `<button type="button" class="btn btn-primary btn-icon-text">
...
const socialIconButton = {
    htmlCode: `<button type="button" class="btn btn-icon btn-facebook">
...
const socialIconTextButton = {
    htmlCode: `<button type="button" class="btn btn-icon-text btn-facebook">
...
let ButtonsComponent = class ButtonsComponent {
    ...
    buttonSizesCode;
    blockButtonCode;
    activeStateButtonCode;
    disabledStateButtonCode;
    disabledStateLinkButtonCode;
    iconButtonCode;
    iconTextButtonCode;
    socialIconButtonCode;
    socialIconTextButtonCode;
    constructor() { }
    ngOnInit() {
