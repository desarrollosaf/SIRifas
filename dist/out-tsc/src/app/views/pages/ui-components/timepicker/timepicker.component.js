...
const defaultTimepicker = {
    htmlCode: `<ngb-timepicker [(ngModel)]="time"></ngb-timepicker>
...
const meridian = {
    htmlCode: `<ngb-timepicker [(ngModel)]="time" [meridian]="true"></ngb-timepicker>
...
const seconds = {
    htmlCode: `<ngb-timepicker [(ngModel)]="time" [seconds]="true" [meridian]="true"></ngb-timepicker>
