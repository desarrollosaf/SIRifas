...
const dropdownButtonVariations = {
    htmlCode: `<div class="d-inline-block" ngbDropdown>
...
const splitButton = {
    htmlCode: `<div class="btn-group" ngbDropdown role="group">
...
const buttonSizing = {
    htmlCode: `<!-- Large button groups (default and split) -->
...
const dropUp = {
    htmlCode: `<div ngbDropdown placement="top-end" class="btn-group">
...
const dropRight = {
    htmlCode: `<div ngbDropdown placement="end-top" class="btn-group">
...
const dropLeft = {
    htmlCode: `<div ngbDropdown placement="start-top" class="btn-group">
