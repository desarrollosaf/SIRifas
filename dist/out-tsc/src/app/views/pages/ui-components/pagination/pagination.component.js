...
const defaultPagination = {
    htmlCode: `<p class="mb-2">Default pagination:</p>
...
const advancedPagination = {
    htmlCode: `<p class="mb-2">Restricted size, no rotation:</p>
...
const customLinksPagination = {
    htmlCode: `<ngb-pagination [collectionSize]="70" [(page)]="currentPage" aria-label="Custom pagination">
...
const paginationSize = {
    htmlCode: `<ngb-pagination [collectionSize]="50" [(page)]="currentPage" size="lg"></ngb-pagination>
...
const paginationAlignment = {
    htmlCode: `<ngb-pagination class="d-flex justify-content-start" [collectionSize]="70" [(page)]="currentPage"></ngb-pagination>
...
const paginationSeparated = {
    htmlCode: `<ngb-pagination class="pagination-separated" [collectionSize]="70" [(page)]="currentPage"></ngb-pagination>`,
    tsCode: `import { Component } from '@angular/core';
import { NgbPaginationModule } from '@ng-bootstrap/ng-bootstrap';
...
const paginationRounded = {
    htmlCode: `<ngb-pagination class="pagination-rounded" [collectionSize]="70" [(page)]="currentPage"></ngb-pagination>`,
    tsCode: `import { Component } from '@angular/core';
import { NgbPaginationModule } from '@ng-bootstrap/ng-bootstrap';
...
let PaginationComponent = class PaginationComponent {
    ...
    advancedPaginationCode;
    customLinksPaginationCode;
    paginationSizeCode;
    paginationAlignmentCode;
    paginationSeparatedCode;
    paginationRoundedCode;
    constructor() { }
    ngOnInit() {
