...
const defaultPopover = {
    htmlCode: `<button type="button" class="btn btn-primary" popoverTitle="Popover title" ngbPopover="And here's some amazing content. It's very engaging. Right?">Click to toggle popover</button>`,
...
const popoverDirecions = {
    htmlCode: `<button type="button" class="btn btn-primary mb-1 mb-md-0 me-1" placement="top" ngbPopover="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
  Popover on top
</button>
