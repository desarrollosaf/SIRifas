...
const defaultBadge = {
    htmlCode: `<h1>Example heading <span class="badge bg-primary">New</span></h1>
...
const buttonBadge = {
    htmlCode: `<button type="button" class="btn btn-primary">
...
const positionedBadge = {
    htmlCode: `<button type="button" class="btn btn-primary position-relative">
  Inbox
...
const contextualVariations = {
    htmlCode: `<span class="badge bg-primary">Primary</span>
...
const pillBadge = {
    htmlCode: `<span class="badge rounded-pill bg-primary">Primary</span>`,
    tsCode: `import { Component } from '@angular/core';
...
const linkBadge = {
    htmlCode: `<a href="" (click)="false" class="badge bg-primary">Primary</a>`,
    tsCode: `import { Component } from '@angular/core';
