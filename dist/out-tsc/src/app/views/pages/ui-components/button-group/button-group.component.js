...
const defaultButtonGroup = {
    htmlCode: `<div class="btn-group" role="group" aria-label="Basic example">
...
const checkboxGroup = {
    htmlCode: `<div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
...
const radioGroup = {
    htmlCode: `<div class="btn-group" role="group" aria-label="Basic radio toggle button group">
...
const buttonToolbar = {
    htmlCode: `<div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
...
const mixedToolbar = {
    htmlCode: `<div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
  <div class="btn-group me-2" role="group" aria-label="First group">
    <button type="button" class="btn btn-primary">1</button>
     ..
  </div>
...
const buttonGroupSizing = {
    htmlCode: `<div class="btn-group btn-group-lg me-2" role="group" aria-label="Basic example">
  <button type="button" class="btn btn-primary">Left</button>
  <button type="button" class="btn btn-primary">Middle</button>
  <button type="button" class="btn btn-primary">Right</button>
</div>
...
const buttonGroupNesting = {
    htmlCode: `<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
  <button type="button" class="btn btn-primary">1</button>
  <button type="button" class="btn btn-primary">2</button>
...
const verticalVariation = {
    htmlCode: `<div class="btn-group-vertical">
...
let ButtonGroupComponent = class ButtonGroupComponent {
    ...
    buttonToolbarCode;
    mixedToolbarCode;
    buttonGroupSizingCode;
    buttonGroupNestingCode;
    verticalVariationCode;
    constructor() { }
    ngOnInit() {
