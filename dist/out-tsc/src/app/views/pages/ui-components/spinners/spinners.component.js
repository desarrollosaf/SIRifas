...
const borderSpinner = {
    htmlCode: `<div class="spinner-border" role="status">
...
const spinnerColors = {
    htmlCode: `<div class="spinner-border text-primary" role="status">
  <span class="visually-hidden">Loading...</span>
</div>
...
const growingSpinner = {
    htmlCode: `<div class="spinner-grow text-primary" role="status">
  <span class="visually-hidden">Loading...</span>
</div>`,
    tsCode: `import { Component } from '@angular/core';
...
const spinnerAlign1 = {
    htmlCode: `<div class="d-flex justify-content-center">
...
const spinnerAlign2 = {
    htmlCode: `<div class="d-flex align-items-center">
...
const spinnerSize = {
    htmlCode: `<div class="spinner-border spinner-border-sm" role="status">
  <span class="visually-hidden">Loading...</span>
</div>
...
const buttonBorderSpinner = {
    htmlCode: `<button class="btn btn-primary me-1" type="button" disabled>
...
let SpinnersComponent = class SpinnersComponent {
    ...
    spinnerAlign4Code;
    spinnerSizeCode;
    buttonBorderSpinnerCode;
    buttonGrowingSpinnerCode;
    constructor() { }
    ngOnInit() {
