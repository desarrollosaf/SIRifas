...
const cardNavigation = {
    htmlCode: `<div class="card text-center">
  <div class="card-header">
...
const imgOverlay = {
    htmlCode: `<div class="card text-white">
...
const bgColor = {
    htmlCode: `<div class="card text-white bg-primary">
...
const gridCards = {
    htmlCode: `<div class="row row-cols-1 row-cols-md-2 g-4">
  <div class="col">
    <div class="card">
