...
let ApexchartsComponent = class ApexchartsComponent {
    lineChartOptions = {};
    barChartOptions = {};
    areaChartOptions = {};
    mixedChartOptions = {};
     ...
     * Line chart options
     */
    getLineChartOptions(themeVariables) {
        return {
            series: [
                {
                    name: "Data a",
     ...
     * Bar chart options
     */
    getBarChartOptions(themeVariables) {
        return {
            series: [{
                    name: 'sales',
     ...
     * Area chart options
     */
    getAreaChartOptions(themeVariables) {
        return {
            series: [
                {
                    name: 'Total Views',
     ...
     * Mixed chart options
     */
    getMixedChartOptions(themeVariables) {
        return {
            series: [
                {
                    name: 'Team A',
     ...
     * Donut chart options
     */
    getDonutChartOptions(themeVariables) {
        return {
            series: [44, 55, 13, 33],
            chart: {
                height: 300,
     ...
     * Pie chart options
     */
    getPieChartOptions(themeVariables) {
        return {
            series: [44, 55, 13, 33],
            chart: {
                height: 300,
     ...
     */
    getHeatMapChartOptions(themeVariables) {
        return {
            series: [{
                    name: 'Metric1',
     ...
     * Radar chart options
     */
    getRadarChartOptions(themeVariables) {
        return {
            series: [
                {
                    name: 'Series 1',
     ...
     */
    getScatterChartOptions(themeVariables) {
        return {
            series: [
                {
                    name: "Sample A",
     ...
     */
    getRadialBarChartOptions(themeVariables) {
        return {
            series: [44, 55, 67, 83],
            chart: {
                height: 300,
...
//# sourceMappingURL=apexcharts.component.js.map